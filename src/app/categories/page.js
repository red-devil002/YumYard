  ...
  async function handleDeleteClick(_id) {
    ...
    return (
        <section className="mt-8 max-w-lg mx-auto">
            ...
            <div className="min-h-screen bg-white py-6 flex flex-col justify-center sm:py-12">
                <div className="relative py-3 sm:max-w-xxl sm:mx-auto">
                    ...
                    <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                        <form className="max-w-lg mx-auto" onSubmit={handleCategorySubmit}>
                            <div>
                            ...
                            <div className="divide-y divide-gray-200">
                                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div className="relative">
                                        <button
                                            className="bg-primary text-white hover:bg-red-300 rounded-md px-2 py-1"
                                            type="submit"
                                        >
            ...
            <div>
                <h2 className="flex items-center justify-center mb-2 text-[40px] text-gray-600  font-bold uppercase ">
                    Existing Categories
                </h2>
                {categories?.length > 0 &&
                    categories.map((c) => (
                        ...
                        >
                            <div className="grow">
                                <h1 className="font-bold text-center text-2xl mb-2">{c.name}</h1>
                                <p>{c.discription}</p>
                            </div>
